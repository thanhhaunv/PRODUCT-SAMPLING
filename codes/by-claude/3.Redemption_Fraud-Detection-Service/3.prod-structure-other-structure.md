# 🚀 Sub-Project 3: Redemption & Transaction Service - Complete Implementation Guide
...
| **🗃️ BACKEND DOMAIN** | | | | |
| Entities | `backend/src/domain/entities/Redemption.ts` | Core redemption entity với business rules | Part04.3.1 Barcode Redemption (FR-007) | Encapsulate redemption logic, state management |
...
| Entities | `backend/src/domain/entities/OfflineRedemptionQueue.ts` | Queue cho offline redemptions | Part04.3.1 Barcode Redemption (FR-007) | Handle POS offline mode sync |
