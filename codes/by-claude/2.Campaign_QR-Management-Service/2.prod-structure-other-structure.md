...
| Domain Events | `backend/src/domain/events/CampaignPublishedEvent.ts` | Event publish campaign cho A/B testing | Part04.3.2 A/B Testing (FR-012) | Trigger A/B experiments khi campaign live |
| **📄 BACKEND APPLICATION** | | | | |
